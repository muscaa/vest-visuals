...
import { PORTFOLIO_MEDIA_VARIANTS } from "@server/db/schema";
import {
    eq,
    and,
    inArray,
...
import * as types from "@type/portfolio/mediaVariants";

export type SelectProps = typeof PORTFOLIO_MEDIA_VARIANTS.$inferSelect;
export type MediaVariant = types.PortfolioMediaVariant;

const bucket = s3Cdn0Buckets.portfolio;
const mediaVariantsTable = PORTFOLIO_MEDIA_VARIANTS;
