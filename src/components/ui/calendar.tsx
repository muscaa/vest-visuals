    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                dropdowns: cn(
                    "w-full flex items-center p font-medium justify-center h-(--cell-size) gap-1.5",
                ...
                caption_label: cn(
                    ...
                    captionLayout === "label"
                        ? "p"
                        : "rounded-(--cell-radius) flex items-center gap-1 p [&>svg]:text-muted-foreground [&>svg]:size-3.5",
